...
export function Settings({ displayName, skillScore, onChangeName, onClose }) {
      ...
      <div style={s.inner}>
        ...
        <div style={s.section}>
          ...
          <div style={s.card}>
            ...
            <div style={s.row}><span style={s.rowLabel}>Engine</span><span style={s.rowVal}>GOD MODE</span></div>
          </div>
        </div>
...
var s = {
  ...
  card:      { background:"rgba(255,255,255,0.04)", border:"1px solid rgba(255,255,255,0.07)", borderRadius:14, padding:"14px 16px" },
