...
var ls = {
  ...
  actions:    { display:"flex", flexDirection:"column", gap:8, padding:"env(safe-area-inset-top,10px) 28px 10px 14px", background:"rgba(0,0,0,0.95)", borderLeft:"1px solid rgba(0,229,255,0.1)", minWidth:72, flexShrink:0, alignItems:"center", justifyContent:"center" },
